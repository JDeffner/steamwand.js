...
export const k_unSteamAccountIDMask = 268435455;
export const k_unSteamAccountInstanceMask = 65535;
...
export const k_usFriendGameInfoQueryPort_NotInitialized = 4095;
...
export const HSERVERQUERY_INVALID = 268435455;
...
export const k_flMaxTimelineEventDuration = 600;
...
export const k_nSteamNetworkingSend_UnreliableNoNagle = 1;
export const k_nSteamNetworkingSend_NoDelay = 4;
export const k_nSteamNetworkingSend_UnreliableNoDelay = 5;
export const k_nSteamNetworkingSend_Reliable = 8;
export const k_nSteamNetworkingSend_ReliableNoNagle = 9;
...
export const k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_All = 134217727;
export const STEAMGAMESERVER_QUERY_PORT_SHARED = 4095;
export const MASTERSERVERUPDATERPORT_USEGAMESOCKETSHARE = 4095;
...
// Skipped (unparseable in steam_api.json): k_SteamDatagramPOPID_dev = ( ( uint32 ) 'd' << 16U ) | ( ( uint32 ) 'e' << 8U ) | ( uint32 ) 'v'